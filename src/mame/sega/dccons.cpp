...
static INPUT_PORTS_START( dc )
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON6 ) //PORT_NAME("P1 C")
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON5 ) //PORT_NAME("P1 Z")
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON6 ) //PORT_NAME("P2 C")
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON6 ) //PORT_NAME("P3 C")
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON5 ) //PORT_NAME("P3 Z")
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON6 ) //PORT_NAME("P4 C")
