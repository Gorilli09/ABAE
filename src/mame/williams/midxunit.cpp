...
static INPUT_PORTS_START( revx )
	...
	PORT_START("DSW") // Two DIP switches at U105 and U108
	PORT_DIPNAME( 0x0001, 0x0000, "Display" )               PORT_DIPLOCATION("SW1@U105:1")
	PORT_DIPSETTING(      0x0000, "Normal" )
	PORT_DIPSETTING(      0x0001, "Mirror" )
	PORT_DIPNAME( 0x0002, 0x0002, "Set Coinage With" )      PORT_DIPLOCATION("SW1@U105:2")
	PORT_DIPSETTING(      0x0002, "DIP Switch" )
	PORT_DIPSETTING(      0x0000, "CMOS" )
	PORT_DIPNAME( 0x001c, 0x001c, DEF_STR( Coinage ))       PORT_DIPLOCATION("SW1@U105:3,4,5")
	PORT_DIPSETTING(      0x001c, "USA1/GER1/FR1" )
	PORT_DIPSETTING(      0x0018, "USA2/GER2/FR2" )
	PORT_DIPSETTING(      0x0014, "USA3/GER3/FR3" )
	PORT_DIPSETTING(      0x0012, "USA4/GER4/FR4" )
	PORT_DIPSETTING(      0x000c, "USAECA/GERECA/FRECA" )
	PORT_DIPSETTING(      0x0000, DEF_STR( Free_Play ))
	PORT_DIPNAME( 0x00e0, 0x00a0, "Credits" )               PORT_DIPLOCATION("SW1@U105:6,7,8")
	...
	PORT_DIPNAME( 0x0300, 0x0300, "Country" )               PORT_DIPLOCATION("SW2@U108:1,2")
	...
	PORT_DIPNAME( 0x0400, 0x0400, "Bill Validator" )        PORT_DIPLOCATION("SW2@U108:3")
	PORT_DIPSETTING(      0x0400, "Not Used")
	PORT_DIPSETTING(      0x0000, "Used")
	PORT_DIPNAME( 0x0800, 0x0000, "Counters" )              PORT_DIPLOCATION("SW2@U108:4")
	PORT_DIPSETTING(      0x0800, "1" )
	PORT_DIPSETTING(      0x0000, "2" )
	PORT_DIPNAME( 0x1000, 0x1000, DEF_STR( Players ) )      PORT_DIPLOCATION("SW2@U108:5")
	PORT_DIPSETTING(      0x1000, "3 Players" )
	PORT_DIPSETTING(      0x0000, "2 Players" )
	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( Cabinet ))       PORT_DIPLOCATION("SW2@U108:6")
	PORT_DIPSETTING(      0x2000, "Rev X" )
	PORT_DIPSETTING(      0x0000, "T2 Retrofit" )
	PORT_DIPNAME( 0x4000, 0x4000, "Video Freeze" )          PORT_DIPLOCATION("SW2@U108:7")
	PORT_DIPSETTING(      0x4000, DEF_STR( Off ))
	PORT_DIPSETTING(      0x0000, DEF_STR( On ))
	PORT_DIPNAME( 0x8000, 0x8000, "Test Switch" )           PORT_DIPLOCATION("SW2@U108:8")
	PORT_DIPSETTING(      0x8000, DEF_STR( Off ))
	PORT_DIPSETTING(      0x0000, DEF_STR( On ))
	PORT_BIT( 0xffff0000, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START("AN0")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, -1.0, 0.0, 0) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_REVERSE PORT_PLAYER(1)

	PORT_START("AN1")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(1)

	PORT_START("AN2")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, -1.0, 0.0, 0) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_REVERSE PORT_PLAYER(2)

	PORT_START("AN3")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(2)

	PORT_START("AN4")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, -1.0, 0.0, 0) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_REVERSE PORT_PLAYER(3)

	PORT_START("AN5")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(3)
INPUT_PORTS_END
