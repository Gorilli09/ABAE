...
static INPUT_PORTS_START( warfa )
	...
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_CODE(MOUSECODE_1_BUTTON1) PORT_CODE(JOYCODE_1_BUTTON1) PORT_CODE(JOYCODE_1_BUTTON8) PORT_NAME("Trigger")
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_CODE(MOUSECODE_1_BUTTON2) PORT_CODE(JOYCODE_1_BUTTON3) PORT_NAME("Discard")
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_CODE(KEYCODE_SPACE) PORT_CODE(JOYCODE_1_BUTTON2) PORT_NAME("Jump")
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_CODE(KEYCODE_E) PORT_CODE(JOYCODE_1_BUTTON4) PORT_NAME("View")
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_CODE(KEYCODE_W) PORT_CODE(JOYCODE_1_YAXIS_UP_SWITCH) PORT_NAME("Forward")
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_CODE(KEYCODE_S) PORT_CODE(JOYCODE_1_YAXIS_DOWN_SWITCH) PORT_NAME("Back")
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_CODE(KEYCODE_A) PORT_CODE(JOYCODE_1_XAXIS_LEFT_SWITCH) PORT_NAME("Dodge Left")
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_CODE(KEYCODE_D) PORT_CODE(JOYCODE_1_XAXIS_RIGHT_SWITCH) PORT_NAME("Dodge Right")
	PORT_BIT( 0xe000, IP_ACTIVE_LOW, IPT_UNUSED)
	...
	PORT_MODIFY("AN.1")
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_Y ) PORT_SENSITIVITY(100) PORT_KEYDELTA(10) PORT_PLAYER(1) PORT_REVERSE
INPUT_PORTS_END
...
static INPUT_PORTS_START( roadburn )
	...
	PORT_MODIFY("IN1")
	PORT_BIT( 0x000f, IP_ACTIVE_LOW, IPT_UNUSED)
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("Brake")
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("Music")
	...
	PORT_MODIFY("AN.1")
	PORT_BIT( 0xff, 0x80, IPT_WHEEL ) PORT_NAME("Steering") PORT_MINMAX(0x00, 0xff) PORT_SENSITIVITY(50) PORT_KEYDELTA(10)

	PORT_MODIFY("AN.2")
	PORT_BIT( 0xff, 0x80, IPT_WHEEL_V ) PORT_NAME("Bank") PORT_MINMAX(0x00, 0xff) PORT_SENSITIVITY(50) PORT_KEYDELTA(10)
INPUT_PORTS_END
...
static INPUT_PORTS_START( cartfury )
	...
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("Boost")
	PORT_BIT( 0x0f00, IP_ACTIVE_HIGH, IPT_CUSTOM) PORT_CUSTOM_MEMBER(FUNC(vegas_state::gearshift_r))
...
void vegas_state::sf2049(machine_config &config)
{
	...
	m_dcs->add_route(0, "speaker", 1.0, 0);
	m_dcs->add_route(1, "speaker", 1.0, 1);
	m_dcs->add_route(2, "speaker", 1.0, 2);
