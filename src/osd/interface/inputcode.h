...
enum input_item_id
{
	...
	// gamepad IDs
	ITEM_ID_LEFTSTICK_XAXIS,
	ITEM_ID_LEFTSTICK_YAXIS,
	ITEM_ID_RIGHTSTICK_XAXIS,
	ITEM_ID_RIGHTSTICK_YAXIS,
	ITEM_ID_LEFTTRIGGER_AXIS,
	ITEM_ID_RIGHTTRIGGER_AXIS,
	ITEM_ID_SOUTH,
	ITEM_ID_EAST,
	ITEM_ID_WEST,
	ITEM_ID_NORTH,
	ITEM_ID_LEFTSHOULDER,
	ITEM_ID_RIGHTSHOULDER,
	ITEM_ID_LEFTTRIGGER,
	ITEM_ID_RIGHTTRIGGER,
	ITEM_ID_LEFTSTICK,
	ITEM_ID_RIGHTSTICK,
	ITEM_ID_BACK,
	ITEM_ID_START,
...
// gamepad axes as absolute devices
constexpr input_code PADCODE_LEFTSTICK_X_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_LEFTSTICK_XAXIS); }
constexpr input_code PADCODE_LEFTSTICK_Y_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_LEFTSTICK_YAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_X_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTTSTICK_XAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_Y_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTTSTICK_YAXIS); }
constexpr input_code PADCODE_LEFTTRIGGER_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_LEFTTRIGGER_AXIS); }
constexpr input_code PADCODE_RIGHTTRIGGER_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTTRIGGER_AXIS); }

#define PADCODE_LEFTSTICK_X PADCODE_LEFTSTICK_X_INDEXED(0)
#define PADCODE_LEFTSTICK_Y PADCODE_LEFTSTICK_Y_INDEXED(0)
#define PADCODE_RIGHTSTICK_X PADCODE_RIGHTSTICK_X_INDEXED(0)
#define PADCODE_RIGHTSTICK_Y PADCODE_RIGHTSTICK_Y_INDEXED(0)
#define PADCODE_LEFTTRIGGER PADCODE_LEFTTRIGGER_INDEXED(0)
#define PADCODE_RIGHTTRIGGER PADCODE_RIGHTTRIGGER_INDEXED(0)

// gamepad axes as absolute half-axes
constexpr input_code PADCODE_LEFTSTICK_X_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_LEFTSTICK_XAXIS); }
constexpr input_code PADCODE_LEFTSTICK_X_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_LEFTSTICK_XAXIS); }
constexpr input_code PADCODE_LEFTSTICK_Y_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_LEFTSTICK_YAXIS); }
constexpr input_code PADCODE_LEFTSTICK_Y_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_LEFTSTICK_YAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_X_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_RIGHTTSTICK_XAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_X_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_RIGHTTSTICK_XAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_Y_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_RIGHTTSTICK_YAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_Y_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_RIGHTTSTICK_YAXIS); }
constexpr input_code PADCODE_LEFTTRIGGER_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_LEFTTRIGGER_AXIS); }
constexpr input_code PADCODE_RIGHTTRIGGER_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_RIGHTTRIGGER_AXIS); }

#define PADCODE_LEFTSTICK_X_POS_ABSOLUTE PADCODE_LEFTSTICK_X_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTSTICK_X_NEG_ABSOLUTE PADCODE_LEFTSTICK_X_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTSTICK_Y_POS_ABSOLUTE PADCODE_LEFTSTICK_Y_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTSTICK_Y_NEG_ABSOLUTE PADCODE_LEFTSTICK_Y_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTSTICK_X_POS_ABSOLUTE PADCODE_RIGHTSTICK_X_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTSTICK_X_NEG_ABSOLUTE PADCODE_RIGHTSTICK_X_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTSTICK_Y_POS_ABSOLUTE PADCODE_RIGHTSTICK_Y_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTSTICK_Y_NEG_ABSOLUTE PADCODE_RIGHTSTICK_Y_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTTRIGGER_POS_ABSOLUTE PADCODE_LEFTTRIGGER_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTTRIGGER_POS_ABSOLUTE PADCODE_RIGHTTRIGGER_POS_ABSOLUTE_INDEXED(0)

// gamepad axes as switches; X/Y are specially handled for left/right/up/down mapping
constexpr input_code PADCODE_LEFTSTICK_LEFT_SWITCH_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_LEFT, ITEM_ID_LEFTSTICK_XAXIS); }
constexpr input_code PADCODE_LEFTSTICK_RIGHT_SWITCH_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_RIGHT, ITEM_ID_LEFTSTICK_XAXIS); }
constexpr input_code PADCODE_LEFTSTICK_UP_SWITCH_INDEXED(int n)    { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_UP, ITEM_ID_LEFTSTICK_YAXIS); }
constexpr input_code PADCODE_LEFTSTICK_DOWN_SWITCH_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_DOWN, ITEM_ID_LEFTSTICK_YAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_LEFT_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_LEFT, ITEM_ID_RIGHTSTICK_XAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_RIGHT_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_RIGHT, ITEM_ID_RIGHTSTICK_XAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_UP_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_UP, ITEM_ID_RIGHTSTICK_YAXIS); }
constexpr input_code PADCODE_RIGHTSTICK_DOWN_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_DOWN, ITEM_ID_RIGHTSTICK_YAXIS); }
constexpr input_code PADCODE_LEFTTRIGGER_POS_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_POS, ITEM_ID_LEFTTRIGGER_AXIS); }
constexpr input_code PADCODE_RIGHTTRIGGER_POS_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_POS, ITEM_ID_RIGHTTRIGGER_AXIS); }

#define PADCODE_LEFTSTICK_LEFT_SWITCH PADCODE_LEFTSTICK_LEFT_SWITCH_INDEXED(0)
#define PADCODE_LEFTSTICK_RIGHT_SWITCH PADCODE_LEFTSTICK_RIGHT_SWITCH_INDEXED(0)
#define PADCODE_LEFTSTICK_UP_SWITCH PADCODE_LEFTSTICK_UP_SWITCH_INDEXED(0)
#define PADCODE_LEFTSTICK_DOWN_SWITCH PADCODE_LEFTSTICK_DOWN_SWITCH_INDEXED(0)
#define PADCODE_RIGHTSTICK_LEFT_SWITCH PADCODE_RIGHTSTICK_LEFT_SWITCH_INDEXED(0)
#define PADCODE_RIGHTSTICK_RIGHT_SWITCH PADCODE_RIGHTSTICK_RIGHT_SWITCH_INDEXED(0)
#define PADCODE_RIGHTSTICK_UP_SWITCH PADCODE_RIGHTSTICK_UP_SWITCH_INDEXED(0)
#define PADCODE_RIGHTSTICK_DOWN_SWITCH PADCODE_RIGHTSTICK_DOWN_SWITCH_INDEXED(0)
#define PADCODE_LEFTTRIGGER_POS_SWITCH PADCODE_LEFTTRIGGER_POS_SWITCH_INDEXED(0)
#define PADCODE_RIGHTTRIGGER_POS_SWITCH PADCODE_RIGHTTRIGGER_POS_SWITCH_INDEXED(0)

// gamepad buttons
constexpr input_code PADCODE_SOUTH_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_SOUTH); }
constexpr input_code PADCODE_EAST_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_EAST); }
constexpr input_code PADCODE_WEST_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_WEST); }
constexpr input_code PADCODE_NORTH_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_NORTH); }
constexpr input_code PADCODE_LEFTSHOULDER_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_LEFTSHOULDER); }
constexpr input_code PADCODE_RIGHTSHOULDER_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTSHOULDER); }
constexpr input_code PADCODE_LEFTTRIGGER_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_LEFTTRIGGER); }
constexpr input_code PADCODE_RIGHTTRIGGER_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTTRIGGER); }
constexpr input_code PADCODE_LEFTSTICK_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_LEFTSTICK); }
constexpr input_code PADCODE_RIGHTSTICK_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTSTICK); }
constexpr input_code PADCODE_BACK_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_BACK); }
constexpr input_code PADCODE_START_INDEXED(int n)    { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_START); }

#define PADCODE_SOUTH PADCODE_SOUTH_INDEXED(0)
#define PADCODE_EAST PADCODE_EAST_INDEXED(0)
#define PADCODE_WEST PADCODE_WEST_INDEXED(0)
#define PADCODE_NORTH PADCODE_NORTH_INDEXED(0)
#define PADCODE_LEFTSHOULDER PADCODE_LEFTSHOULDER_INDEXED(0)
#define PADCODE_RIGHTSHOULDER PADCODE_RIGHTSHOULDER_INDEXED(0)
#define PADCODE_LEFTTRIGGER PADCODE_LEFTTRIGGER_INDEXED(0)
#define PADCODE_RIGHTTRIGGER PADCODE_RIGHTTRIGGER_INDEXED(0)
#define PADCODE_LEFTSTICK PADCODE_LEFTSTICK_INDEXED(0)
#define PADCODE_RIGHTSTICK PADCODE_RIGHTSTICK_INDEXED(0)
#define PADCODE_BACK PADCODE_BACK_INDEXED(0)
#define PADCODE_START PADCODE_START_INDEXED(0)

// gamepad hats
constexpr input_code PADCODE_DPADUP_INDEXED(int n)    { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_DPADUP); }
constexpr input_code PADCODE_DPADDOWN_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_DPADDOWN); }
constexpr input_code PADCODE_DPADLEFT_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_DPADLEFT); }
constexpr input_code PADCODE_DPADRIGHT_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_DPADRIGHT); }

#define PADCODE_DPADUP    PADCODE_DPADUP_INDEXED(0)
#define PADCODE_DPADDOWN  PADCODE_DPADDOWN_INDEXED(0)
#define PADCODE_DPADLEFT  PADCODE_DPADLEFT_INDEXED(0)
#define PADCODE_DPADRIGHT PADCODE_DPADRIGHT_INDEXED(0)
