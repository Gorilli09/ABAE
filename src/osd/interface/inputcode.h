...
constexpr input_code PADCODE_LEFTX_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_LEFTX); }
constexpr input_code PADCODE_LEFTY_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_LEFTY); }
constexpr input_code PADCODE_RIGHTX_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTX); }
constexpr input_code PADCODE_RIGHTY_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTY); }
constexpr input_code PADCODE_LEFTTRIGGER_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_LEFTTRIGGER); }
constexpr input_code PADCODE_RIGHTTRIGGER_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NONE, ITEM_ID_RIGHTTRIGGER); }

#define PADCODE_LEFTX PADCODE_LEFTX_INDEXED(0)
#define PADCODE_LEFTY PADCODE_LEFTY_INDEXED(0)
#define PADCODE_RIGHTX PADCODE_RIGHTX_INDEXED(0)
#define PADCODE_RIGHTY PADCODE_RIGHTY_INDEXED(0)
...
constexpr input_code PADCODE_LEFTX_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_LEFTX); }
constexpr input_code PADCODE_LEFTX_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_LEFTX); }
constexpr input_code PADCODE_LEFTY_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_LEFTY); }
constexpr input_code PADCODE_LEFTY_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_LEFTY); }
constexpr input_code PADCODE_RIGHTX_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_RIGHTX); }
constexpr input_code PADCODE_RIGHTX_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_RIGHTX); }
constexpr input_code PADCODE_RIGHTY_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_RIGHTY); }
constexpr input_code PADCODE_RIGHTY_NEG_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_NEG, ITEM_ID_RIGHTY); }
constexpr input_code PADCODE_LEFTTRIGGER_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_LEFTTRIGGER); }
constexpr input_code PADCODE_RIGHTTRIGGER_POS_ABSOLUTE_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_ABSOLUTE, ITEM_MODIFIER_POS, ITEM_ID_RIGHTTRIGGER); }

#define PADCODE_LEFTX_POS_ABSOLUTE PADCODE_LEFTX_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTX_NEG_ABSOLUTE PADCODE_LEFTX_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTY_POS_ABSOLUTE PADCODE_LEFTY_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_LEFTY_NEG_ABSOLUTE PADCODE_LEFTY_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTX_POS_ABSOLUTE PADCODE_RIGHTX_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTX_NEG_ABSOLUTE PADCODE_RIGHTX_NEG_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTY_POS_ABSOLUTE PADCODE_RIGHTY_POS_ABSOLUTE_INDEXED(0)
#define PADCODE_RIGHTY_NEG_ABSOLUTE PADCODE_RIGHTY_NEG_ABSOLUTE_INDEXED(0)
...
constexpr input_code PADCODE_LEFTSTICK_LEFT_SWITCH_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_LEFT, ITEM_ID_LEFTX); }
constexpr input_code PADCODE_LEFTSTICK_RIGHT_SWITCH_INDEXED(int n) { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_RIGHT, ITEM_ID_LEFTX); }
constexpr input_code PADCODE_LEFTSTICK_UP_SWITCH_INDEXED(int n)    { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_UP, ITEM_ID_LEFTY); }
constexpr input_code PADCODE_LEFTSTICK_DOWN_SWITCH_INDEXED(int n)  { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_DOWN, ITEM_ID_LEFTY); }
constexpr input_code PADCODE_RIGHTSTICK_LEFT_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_LEFT, ITEM_ID_RIGHTX); }
constexpr input_code PADCODE_RIGHTSTICK_RIGHT_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_RIGHT, ITEM_ID_RIGHTX); }
constexpr input_code PADCODE_RIGHTSTICK_UP_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_UP, ITEM_ID_RIGHTY); }
constexpr input_code PADCODE_RIGHTSTICK_DOWN_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_DOWN, ITEM_ID_RIGHTY); }
constexpr input_code PADCODE_LEFTTRIGGER_POS_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_POS, ITEM_ID_LEFTTRIGGER); }
constexpr input_code PADCODE_RIGHTTRIGGER_POS_SWITCH_INDEXED(int n)   { return input_code(DEVICE_CLASS_GAMEPAD, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_POS, ITEM_ID_RIGHTTRIGGER); }
