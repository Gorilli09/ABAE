...
#define CORE_INPUT_TYPES_WHEEL_V \
		CORE_INPUT_TYPES_BEGIN(wheel_v) \
		INPUT_PORT_ANALOG_TYPE(   1, PLAYER1,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                   input_seq(), input_seq(KEYCODE_W), input_seq(KEYCODE_S) ) \
		INPUT_PORT_ANALOG_TYPE(   2, PLAYER2,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   3, PLAYER3,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   4, PLAYER4,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   5, PLAYER5,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   6, PLAYER6,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   7, PLAYER7,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   8, PLAYER8,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(   9, PLAYER9,  WHEEL_V,                N_p("input-name", "%p Wheel V"),                 input_seq(), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  10, PLAYER10, WHEEL_V,                N_p("input-name", "%p Wheel V"),                input_seq(), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()
